async function drawSampleInput(data, featureIdx, container) {
    ...
    //Draw the feature.
    let hm = new HeatMap(document.getElementById(container), {x: x, y: y, z: z}, {
        noSvg: true,
        showAxes: true,
        paddingLeft: 50,
        paddingRight: 50,
        ...
        borderWidth: 0,
        title: {
            text: 'Sample output for the first sensor feature.'
        },
        xAxisLabel: {
            text: 'Cycle Sequence'
        },
